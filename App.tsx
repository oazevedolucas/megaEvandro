  ...
  return (
    <ScrollView key="scroolView">
      <View style={styles.container} key="17">
        <Text key="11">Informe a quantidade de jogos</Text>
        <TextInput
          key="12"
      ...
      <View style={styles.sortedNumbers} key="1">
        ...
        >
          Informe as Dezenas que foram Sorteadas:
        </Text>
        ...
        <View style={styles.inputsContainer} key="3">
          <TextInput
            ...
            onChangeText={(e) => {
              setSortedValues({ ...sortedValues, number0: e })
            }}
            key="4"
          ...
          <TextInput
            ...
            keyboardType="number-pad"
            onChangeText={(e) => {
              setSortedValues({ ...sortedValues, number1: e })
            }}
            key="5"
            value={String(sortedValues.number1)}
          />
          <TextInput
            style={styles.sortedInput}
            keyboardType="number-pad"
            onChangeText={(e) => {
              setSortedValues({ ...sortedValues, number2: e })
            }}
            key="6"
            value={String(sortedValues.number2)}
          />
          <TextInput
            style={styles.sortedInput}
            keyboardType="number-pad"
            onChangeText={(e) => {
              setSortedValues({ ...sortedValues, number3: e })
            }}
            key="7"
            value={String(sortedValues.number3)}
          />
          <TextInput
            style={styles.sortedInput}
            keyboardType="number-pad"
            onChangeText={(e) => {
              setSortedValues({ ...sortedValues, number4: e })
            }}
            key="8"
            value={String(sortedValues.number4)}
          />
          <TextInput
            style={styles.sortedInput}
            keyboardType="number-pad"
            onChangeText={(e) => {
              setSortedValues({ ...sortedValues, number5: e })
            }}
            key="9"
            value={String(sortedValues.number5)}
          />
        </View>
        <Button title="Verificar Número" key="10" onPress={(e) => {
          conference()
        }} />
      </View>
    </ScrollView >
